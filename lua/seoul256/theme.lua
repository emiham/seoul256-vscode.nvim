...
M.plugins = {
  ...
  NvimDapUi = {
    ...
    DapUICurrentFrameName = { M.plugins.NvimDapUi.DapUIBreakpointsCurrentLine },
...
if vim.g.seoul256_italic_comments == true then
  ...
  M.treesitter.TSComment =
    { fg = colors.green, bg = colors.none, style = "italic" }
end

if vim.g.seoul256_italic_keywords == true then
  M.syntax.Conditional =
    { fg = colors.purple, bg = colors.none, style = "italic" }
...
if vim.g.seoul256_italic_variables == true then
  M.syntax.Identifier =
    { fg = colors.pink, bg = colors.none, style = "italic" }
